    ...
    return (
        <aside className="layout__aside">
            ...
            <header className="aside__header">
                <h1 className="aside__title">Hola, Sergio</h1>
            </header>
                ...
                <div className="aside__profile-info">
                    ...
                    <div className="profile-info__general-info">
                        ...
                        <div className="general-info__container-names">
                            <a href="#" className="container-names__name">Sorrobicho</a>
                            <p className="container-names__nickname">GQ FUDDER</p>
                        </div>
                    </div>
                ...
                <div className="aside__container-form">
                    ...
                    <form className="container-form__form-post">
                        ...
                        <div className="form-post__inputs">
                            <label for="post" className="form-post__label">¿Que estás FUDDEANDO hoy?</label>
