...
export default function PublicationList({ publications, getPublications, page, setPage, more, setMore }) {
                            ...
                            <div className="post__container">
                                ...
                                <div className="post__body">
                                    ...
                                    <div className="post__user-info">
                                        ...
                                        <Link className="user-info__create-date"><ReactTimeAgo date={publication.created_at} locale="es-ES" /></Link>
                                    </div>

                                    <h4 className="post__content">{publication.text}</h4>
                                    {publication.file && <img src={Global.url + "publication/media/" + publication.file} height={150} width={150} />}
